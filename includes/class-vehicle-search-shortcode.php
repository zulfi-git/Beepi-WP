...
class Vehicle_Search_Shortcode {
    ...
    public function render_search_shortcode($atts) {
        ...
        <div class="max-w-full mx-auto px-4">
            <form id="vehicle-search-form" class="flex justify-center mx-auto my-4" method="GET" action="<?php echo $results_page; ?>">
            ...
            <div id="search-error" class="text-red-600 text-center mt-2 font-medium" style="display: none;"></div>
        </div>
